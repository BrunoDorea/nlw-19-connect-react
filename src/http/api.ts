...
export const getSubscribeToEventUrl = () => {
    return `https://devstage.onrender.com/subscriptions`
}
...
export const getAccessInviteLinkUrl = (subscriberId: string) => {
    return `https://devstage.onrender.com/invites/${subscriberId}`
}
...
export const getGetRankingUrl = () => {
    return `https://devstage.onrender.com/ranking`
}
...
export const getGetSubscriberInviteCountUrl = (subscriberId: string) => {
    return `https://devstage.onrender.com/subscribers/${subscriberId}/ranking/count`
}
...
export const getGetSubscriberInviteClicksUrl = (subscriberId: string) => {
    return `https://devstage.onrender.com/subscribers/${subscriberId}/ranking/clicks`
}
...
export const getGetSubscriberRankingPositionUrl = (subscriberId: string) => {
    return `https://devstage.onrender.com/subscribers/${subscriberId}/ranking/position`
}
